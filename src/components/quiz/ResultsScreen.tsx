...
export const ResultsScreen: React.FC<ResultsScreenProps> = ({ score, totalQuestions, onRetry, answers }) => {
  ...
  else resultMessage = 'Perlu Ditingkatkan. Kami menyarankan untuk meninjau kembali materi Modul 3 — Etika, Keamanan, dan Aspek Hukum AI.';
      ...
      <CardContent className="px-4 md:px-8 py-4 md:py-6 flex flex-col items-center">
        <div className="flex gap-4 md:gap-8 mb-6 md:mb-8">
          <div className="text-center">
            <p className="poppins text-4xl md:text-5xl font-black text-primary mb-1 md:mb-2">{score}<span className="text-xl md:text-2xl text-muted-foreground">/{totalQuestions}</span></p>
