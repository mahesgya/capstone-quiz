  ...
  return (
    <Card className="w-full max-w-2xl mx-auto mt-8 border-t-4 border-t-primary shadow-lg animate-in fade-in slide-in-from-bottom-4 duration-500">
      <CardHeader className="text-center space-y-4">
        ...
        <CardTitle className="poppins text-2xl md:text-3xl text-primary font-bold leading-tight">Evaluasi Modul 3</CardTitle>
        <CardDescription className="poppins text-sm md:text-base text-card-foreground/80 max-w-lg mx-auto">
          Selamat datang di evaluasi Modul 3 — Etika, Keamanan, dan Aspek Hukum AI untuk mahasiswa Ilmu Komputer IPB.
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-6 px-5 md:px-8 py-6">
        <div className="bg-muted p-4 rounded-lg border border-border">
          ...
          <ul className="poppins space-y-2 text-xs md:text-sm text-muted-foreground list-disc pl-5">
            <li>Terdapat <strong>{totalQuestions} pertanyaan</strong> pilihan ganda berdasarkan Modul Literasi AI.</li>
